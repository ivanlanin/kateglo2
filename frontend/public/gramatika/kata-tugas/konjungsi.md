...
|:----------------|:------------------------|:----------------|
| *di, ke, dari, pada* | *karena, sebab* | *dan, atau, tetapi* |
| *dengan, tanpa* | *sejak, semenjak, sedari* | *melainkan, padahal* |
| *oleh, untuk, bagi* | *setelah, sesudah, sehabis* | *sedangkan, meskipun* |
| | *sebelum* | *walaupun, biarpun* |

Contoh: kata *sebelum* berfungsi sebagai **konjungsi** dalam *Dia berangkat sebelum saya datang*, tetapi sebagai **preposisi** dalam *Dia berangkat sebelum pukul lima*.
...
| Konjungsi | Makna |
|-----------|-------|
| *dan* | hubungan penambahan |
| *atau* | hubungan pemilihan |
| *melainkan* | hubungan perlawanan |
| *padahal* | hubungan pertentangan |
| *sedangkan* | hubungan pertentangan |
| *serta* | hubungan pendampingan |
...
| Konjungsi | Contoh |
|-----------|--------|
| *baik ... maupun ...* | Baik Pak Anwar maupun anaknya tidak suka merokok. |
| *tidak hanya ..., tetapi juga ...* | Kita tidak hanya harus setuju, tetapi juga harus patuh terhadap putusan itu. |
| *bukan hanya ..., melainkan juga ...* | Bukan hanya masalah itu, melainkan juga masalah pendidikan. |
| *demikian ... sehingga ...* | Mobil itu larinya demikian cepatnya sehingga sangat sukar untuk dipotret. |
| *sedemikian rupa sehingga ...* | Kita harus mengerjakannya sedemikian rupa sehingga hasilnya benar-benar baik. |
| *apa(kah) ... atau ...* | Apa(kah) Anda setuju atau tidak, kami akan jalan terus. |
| *entah ... entah ...* | Entah disetujui entah tidak, dia tetap akan mengusulkan gagasannya. |
| *jangankan ..., ... pun ...* | Jangankan orang tua, orang lain pun harus dihormati. |
...
**Bersamaan dengan peristiwa lain:**
*begitu, demi, ketika, sambil, selagi, selama, sementara, seraya, sewaktu, tatkala*

**Setelah peristiwa lain:**
...
### 13) Perbandingan
*... sama ... dengan ..., ... lebih ... dari ... daripada ...*

Contoh pemakaian:

- *Ketika saya datang, acara sudah dimulai.*
- *Saya akan datang jika hari tidak hujan.*
- *Mereka harus belajar giat agar naik kelas.*
- *Pembangunan terap berjalan terus meskipun dana menipis.*
...
| Makna | Konjungsi |
|-------|-----------|
| Pertentangan | *Biarpun demikian, Biarpun begitu, Sekalipun demikian, Walaupun demikian, Meskipun demikian, Sungguhpun demikian* |
| Kelanjutan | *Kemudian, Sesudah itu, Setelah itu, Selanjutnya, Berikutnya* |
| Penambahan | *Tambahan pula, Lagi pula, Selain itu* |
| Kebalikan | *Sebaliknya* |
| Keadaan sebenarnya | *Sesungguhnya, Bahwasanya* |
| Penguatan | *Malah(an), Bahkan* |
| Pertentangan | *Akan tetapi, Namun* |
| Keeksklusifan/keinklusifan | *Kecuali itu, Di samping itu* |
| Konsekuensi | *Dengan demikian* |
| Akibat | *Oleh karena itu, Oleh sebab itu* |
| Mendahului | *Sebelum itu* |
...
- *Pak Darta terkena penyakit kencing manis. **Selain itu**, dia juga mengidap tekanan darah tinggi.*
- *Keadaan memang sudah mulai aman. **Akan tetapi**, kita harus tetap waspada.*

> **Catatan:** Konjungsi *tetapi* dalam bahasa baku tidak dipakai untuk memulai suatu kalimat. Sebagai gantinya, dipakailah *akan tetapi*.
>
> Karena konjungsi antarkalimat menghubungkan dua kalimat yang utuh, subjek pada kalimat kedua tetap dipertahankan meskipun subjeknya sama dengan kalimat sebelumnya.
