...
Kata *tersebut* sering digunakan di dalam tulisan untuk mengacu pada nomina yang telah disebutkan (116b). Alih-alih kata *tersebut*, kata *itu* dapat digunakan dan dianggap lebih formal.
...
| Penggolong | Untuk | Contoh |
|---|---|---|
| *orang* | manusia | *guru, anak, kawan* |
| *ekor* | binatang | *sapi, ayam, ular* |
| *buah* | berbagai benda | *rumah, mobil, durian* |

**b) Penggolong khas:**

| Penggolong | Untuk | Contoh |
|---|---|---|
| *batang* | tumbuhan atau benda panjang dan bulat | *pohon, bambu, besi* |
| *bentuk* | benda berkeluk | *cincin, gelang, anting* |
| *bidang* | tanah, sawah, bidang luas | |
| *biji* | benda kecil | *buah, mata* |
| *bilah* | benda tajam | *pisau, pedang, keris* |
| *butir* | benda bulat dan kecil | *padi, kelereng, telur* |
| *carik* | benda tipis yang dapat disobek | *kertas, surat, koran* |
| *helai* | benda tipis dan halus | *kertas, kain, daun* |
| *keping* | benda tipis dan pipih | *uang logam, papan, seng* |
| *kuntum* | bunga | *mawar, melati, anggrek* |
| *laras* | benda berlaras | *senapan, bedil, karaben* |
| *lembar* | benda tipis | *papan, kertas, kain* |
| *patah* | kata | |
| *potong* | pakaian atau kayu | *baju, kain, celana* |
| *pucuk* | surat, pistol, senapan | |
| *tangkai* | yang bertangkai | *bunga, pena, sapu* |
| *utas* | benda kecil dan panjang | *tali, kawat, benang* |
...
Di samping penggolong nomina, bahasa Indonesia juga menggunakan sejumlah kata, seperti *iris*, *potong*, dan *gelas* yang mengikuti numeralia pada frasa nominal. Kata-kata tersebut lazim disebut partitif, yaitu kata yang menyatakan kuantitas benda yang mengikutinya. Kata-kata itu mempunyai pola dan perilaku yang sama dengan penggolong dalam konstruksi frasa nominal.

| Jenis | Partitif | Untuk |
|---|---|---|
| a) Satuan | *belah, carik, iris, potong* | bagian yang dipotong/diiris |
| b) Wadah | *botol, bungkus, ember, gelas, karung, kaleng* | isi wadah |
| c) Ukuran | *kilo, kodi, liter, lusin, meter* | satuan ukuran |
| d) Badan | *genggam, suap, teguk* | bagian tubuh sebagai takaran |
| e) Flora | *rumpun, sisir, tandan, bulir, penggal* | satuan tumbuhan/kelompok |
...
Berikut diberikan beberapa makna hubungan antara nomina inti (N1) dan nomina pewatas (N2):

| No. | Makna | Contoh |
|---|---|---|
| 1 | Asal (N1 berasal dari N2) | *dodol garut, orang Medan, surat menteri* |
| 2 | Bahan (N1 terbuat dari N2) | *cincin mas, kursi rotan, botol plastik* |
| 3 | Peruntukan (N1 untuk N2) | *asrama putri, sepatu tenis, botol susu* |
| 4 | Bidang kegiatan | *pemain bola, guru musik, pelatih sepak bola* |
| 5 | Bagian/partitif (N1 bagian dari N2) | *ban mobil, atap rumah, kaki meja* |
| 6 | Kelamin (N1 berjenis kelamin N2) | *anak perempuan, polisi wanita, ayam jantan* |
| 7 | Apositif restriktif (N1 bernama N2) | *kota Jakarta, danau Toba, bulan Maret* |
| 8 | Tempat (N1 berada di N2) | *jam dinding, pegawai bank, guru SMP* |
| 9 | Hasil proses | *mobil rakitan, sutra tiruan, kain batik* |
| 10 | Milik (N1 milik N2) | *kapal Indonesia, mobil polisi, perusahaan Jepang* |
| 11 | Agentif/aktor | *pembunuh binatang, penulis buku, pembela negara* |
| 12 | Objektif (N1 dibuat oleh N2) | *lamaran saya, tulisan beliau, pembicaraan mereka* |
| 13 | Tematis (N1 merupakan atribut N2) | *kesetiaan suami, ketaatan warga, kejujuran pegawai* |

Frasa nominal yang pewatasnya nomina dapat diperluas lagi dengan menambahkan nomina lain sebagai pewatas:
...
Contoh apositif restriktif:

- (146a) *Indonesia* merdeka pada tahun 1945. → *Indonesia* dapat menggantikan keseluruhan
- (146b) *Dia lahir di kota Padang.* → *Dia lahir di Padang.*
