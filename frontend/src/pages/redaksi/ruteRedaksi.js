...
export const ruteHalamanRedaksi = [
  ...
  { path: '/redaksi/kata-hari-ini', Component: KataHariIniAdmin, izinDibutuhkan: ['edit_entri'] },
  { path: '/redaksi/kata-hari-ini/:id', Component: KataHariIniAdmin, izinDibutuhkan: ['edit_entri'] },
