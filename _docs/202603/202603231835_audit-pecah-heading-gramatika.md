...
- Total halaman konten yang masih memiliki heading internal: 51 file
- Total heading internal yang terdeteksi: 217 heading
- Bab yang terdampak: 10 bab
...
3. `frontend/public/gramatika/tata-bahasa/sintaksis.md` — 11 heading
4. `frontend/public/gramatika/verba/verba-taktransitif-dengan-prefiks-meng.md` — 9 heading
5. `frontend/public/gramatika/kalimat/kalimat-imperatif.md` — 8 heading
6. `frontend/public/gramatika/kalimat/kalimat-dan-kemasan-informasi.md` — 7 heading
7. `frontend/public/gramatika/nomina/perluasan-nomina-ke-kanan.md` — 7 heading
